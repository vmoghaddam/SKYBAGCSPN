'use strict';
app.controller('vrTabanController', ['$scope', '$location', 'flightService', 'authService', '$routeParams', '$rootScope', '$window', '$http', function ($scope, $location, flightService, authService, $routeParams, $rootScope, $window, $http) {
    $scope.isNew = true;
    ...
    $scope.fill = function (data) {
        ...
        $scope.entity.ActionBy = $scope.tempData.user;
        flightService.epGetFlightLocal($scope.tempData.FlightId).then(function (response) {
            ...
            $scope.entity.PIC = response.Data.PIC;
    ...
    $scope.$on('InitVrTaban', function (event, prms) {
        $scope.tempData = null;
